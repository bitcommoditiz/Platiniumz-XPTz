...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // XPTz: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // XPTz: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // XPTz: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // 1 Oz of XPTz: 2.5 minutes
