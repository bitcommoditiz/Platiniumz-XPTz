...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "XPTz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "xptz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "xptz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.xptz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.xptz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XPTz is probably already running."), addrBind.ToString().c_str());
        else
